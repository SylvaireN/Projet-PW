...
<body>
    <div class="container">
        ...
        <a href="index.php?page=">Ajouter un Educateur</a>
                ...
                <tbody>
                    <?php foreach ($educateur as $educ): ?>
                        <tr>
                            ...
                            <td><?php echo $educ->getRole(); ?></td>
                            <td><?php echo $educ->getLicenceID(); ?></td>
                            <td>
                                <a href="index.php?page=view&action=viewCategorie&id=<?php echo $educ->getId(); ?>">Voir</a>
